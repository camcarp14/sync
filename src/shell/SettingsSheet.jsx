      ...
      <Sheet onClose={onClose} title="Settings" headTrailing={<Status state={connection} label={s.settings.apiKey ? "Key set" : "No key"} />}>
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          <section>
            ...
            <Segmented
              options={[
                { key: "night", label: "Obsidian" },
                { key: "day", label: "Quartz" },
                { key: "auto", label: "Auto" },
              ]}
          ...
          {/* ── what the screen actually reported ───────────────────── */}
          <section>
            <SectionHeader title="Viewport" trailing={vp.standalone ? "Installed" : "Browser tab"} />
            <div
              className="t-mono"
